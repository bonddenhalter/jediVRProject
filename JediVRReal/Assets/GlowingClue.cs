...
public class GlowingClue : MonoBehaviour
{
    ...
    private SpriteRenderer[] crystals;

    // Start is called before the first frame update
    void Start()
    {
        crystals = GetComponentsInChildren<SpriteRenderer>();
        foreach (SpriteRenderer sprite in crystals) //start out invisible
        {
    ...
    void Update()
    {
        ...
        foreach (SpriteRenderer sprite in crystals)
        {
            Color color = sprite.color;
